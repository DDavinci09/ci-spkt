                    ...
                    <tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><?= $sk['kode_sktlk'] ?></td>
                                ...
                                <td class="align-middle text-center">
                                <?php if ($user["level"] !== 'Pelapor') { ?>
                                    <a href="<?= base_url(); ?>SKTLK/detailPetugas/<?= $sk['id_sktlk']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-fw fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-danger btn-delete" onclick="deleteConfirmation('<?= base_url(); ?>SKTLK/hapusPetugas/<?= $sk['id_sktlk']; ?>')"><i class="fas fa-fw fa-fw fa-trash"></i></a>
                                <?php } ?>
                                <?php if ($user["level"] == 'Pelapor') { ?>
                                    <a href="<?= base_url(); ?>SKTLK/detail/<?= $sk['id_sktlk']; ?>" class="btn btn-sm btn-primary"><i class="fas fa-fw fa-edit"></i></a>
