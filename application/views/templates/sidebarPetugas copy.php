...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link pb-0" href="<?= base_url(); ?>Petugas">
            <i class="fas fa-fw fa-home"></i>
    ...
    <li class="nav-item">
        <a class="nav-link pb-0" href="#">
            ...
            <span><b>Data Petugas</b></span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link pb-0" href="#">
            <i class="fas fa-fw fa-marker"></i>
            <span><b>Data Pelapor</b></span></a>
    </li>
    <?php } ?>
    ...
    <li class="nav-item">
        <a class="nav-link pb-0" href="<?= base_url(); ?>Petugas/LP">
            <i class="fas fa-fw fa-marker"></i>
            <span><b>Data LP</b></span></a>
    </li>
    
    <li class="nav-item">
        <a class="nav-link pb-0" href="<?= base_url(); ?>Petugas/SKTLK">
            <i class="fas fa-fw fa-marker"></i>
            <span><b>Data SKTLK</b></span></a>
    </li>
    
    <li class="nav-item">
        <a class="nav-link pb-0" href="<?= base_url(); ?>Petugas/SIK">
            <i class="fas fa-fw fa-marker"></i>
            <span><b>Data SIK</b></span></a>
    </li>

    <li class="nav-item">
        <a href="#laporan" data-toggle="collapse" aria-expanded="false" class="nav-link pb-0 dropdown-toggle"><i class="fas fa-fw fa-marker"></i> <span><b>Laporan</b></span></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?= base_url('authPetugas/logout'); ?>">Logout</a>
                </div>
            </div>
        </div>
    </div>
